...
private:
    ...
    static void syn_flood(IPv4Address d_ip, uint16_t d_port, unsigned counter);

public:
    SynFlood(const IPv4Address &dstIp, uint16_t dstPort, unsigned int counter, unsigned int threads_number);
    void run();
